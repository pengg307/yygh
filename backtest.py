...
from tqsdk import TqApi, TqAuth, TqBacktest, TargetPosTask, TqReplay
...
#api = TqApi(backtest=TqBacktest(start_dt=date(2018, 5, 1), end_dt=date(2018, 10, 1)), auth=TqAuth("aimoons", "112411"))
api = TqApi(backtest = TqReplay(date(2020,10,15)), auth=TqAuth("aimoons", "112411"))
# 获得 m1901 5分钟K线的引用
klines = api.get_kline_serial("DCE.m2101", 5 * 60 * 60, data_length=15)
