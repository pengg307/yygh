...
from tqsdk import TqAuth, TqSim, TqAccount
...
api = TqApi(web_gui=":16666",backtest=TqBacktest(start_dt=date(2020, 8, 6), end_dt=date(2020, 9, 5)), auth=TqAuth("aimoons", "112411"))
